...
You need to introduce your own Google API key and Google Custom Search Engine ID (in the app's SearchActivity) in order to use the custom search engine on google.com.
